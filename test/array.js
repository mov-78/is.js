...
describe( 'bundle:array' , function () {
  ...
  it( 'is.array' , function () {
    ...
    expect( is.array( { length : '-' } ) ).to.be.false
    ...
    expect( is.not.array( { length : '-' } ) ).to.be.true
  ...
  it( 'is.arrayLike' , function () {
    ...
    expect( is.arrayLike( { length : '-' } ) ).to.be.false
    expect( is.arrayLike( [] ) ).to.be.true
    ...
    expect( is.not.arrayLike( { length : '-' } ) ).to.be.true
    expect( is.not.arrayLike( [] ) ).to.be.false
  ...
  it( 'is.arguments' , function () {
    ...
    expect( is.arguments( { length : '-' } ) ).to.be.false
    expect( is.arguments( [] ) ).to.be.false
    ...
    expect( is.not.arguments( { length : '-' } ) ).to.be.true
    expect( is.not.arguments( [] ) ).to.be.true
  ...
  it( 'is.emptyArray' , function () {
    ...
    expect( is.emptyArray( 'foo' ) ).to.be.false
    ...
    expect( is.emptyArray( { length : 5 } ) ).to.be.false
    expect( is.emptyArray( { length : '-' } ) ).to.be.false
    ...
    expect( is.not.emptyArray( 'foo' ) ).to.be.true
    ...
    expect( is.not.emptyArray( { length : 5 } ) ).to.be.true
    expect( is.not.emptyArray( { length : '-' } ) ).to.be.true
