describe( 'bundle:number' , function () {
  ...
  it( 'is.number' , function () {
    ...
    expect( is.not.number( -1 / 0 ) ).to.not.be.ok()
    expect( is.not.number( '0' ) ).to.be.ok() // ←
  ...
  it( 'is.nan' , function () {
    ...
    expect( is.not.nan( -1 / 0 ) ).to.be.ok()
    expect( is.not.nan( 'one' ) ).to.be.ok()
  ...
  it( 'is.finite' , function () {
    ...
    expect( is.not.finite( '0' ) ).to.be.ok()
  ...
  it( 'is.integer' , function () {
    ...
    expect( is.not.integer( '0' ) ).to.be.ok()
    ...
    expect( is.not.integer( -1 / 0 ) ).to.be.ok()
    expect( is.not.integer( MAX_SAFE_INTEGER ) ).to.not.be.ok()
    expect( is.not.integer( MIN_SAFE_INTEGER ) ).to.not.be.ok()
    expect( is.not.integer( MAX_SAFE_INTEGER + 1 ) ).to.not.be.ok()
    expect( is.not.integer( MIN_SAFE_INTEGER - 1 ) ).to.not.be.ok()
  ...
  it( 'is.safeInteger' , function () {
    ...
    expect( is.not.safeInteger( '0' ) ).to.be.ok()
