...
( function ( root , factory ) {
  ...
  is.use( function arrayBundle( util ) {
    ...
    ; ( function ( makePredicate ) { // eslint-disable-line semi-spacing
      ...
      //
      // __is.arrayIncludes( array , member )__
      //
      ...
      //
      // __is.arrayDeepIncludes( array , member )__
      //
      ...
      return function predicate( array , member ) {

        var index
        var length

        // Works with both true arrays and _array-like_ objects.
  ...
  // ### bundle:symbol
  is.use( function symbolBundle( util ) {

    //
    // __is.symbol( value )__
    //
    // Checks whether given value is a symbol.
    //
    if ( typeof Symbol === 'function' ) {
      util.addPredicate( 'symbol' , function isSymbol( value ) {
        return typeof value === 'symbol'
      } )
    } else {
      util.addPredicate( 'symbol' , function isSymbol() {
        return false
      } )
    }
